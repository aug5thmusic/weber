...
\header { instrument = "Trumpet II — original C/D" tagline = ##f }
\score {
...
\barNumberCheck #58  \set Staff.weberCueId = "violinOneI:58" \set Staff.weberCueLabel = "Vl. I" \cueDuringWithClef "violinOneI" #UP "treble" { \voiceTwo \override MultiMeasureRest.staff-position = #2  R1  \noBreak |  R1  | \revert MultiMeasureRest.staff-position } \oneVoice  | % PART I 58-59
...
\barNumberCheck #134  \set Staff.weberCueId = "fluteI:134" \set Staff.weberCueLabel = "Fl." \cueDuringWithClef "fluteI" #UP "treble" { \voiceTwo \override MultiMeasureRest.staff-position = #-4  R1  \noBreak |  R1  | \revert MultiMeasureRest.staff-position } \oneVoice  | % PART I 134-135
...
\barNumberCheck #194  \set Staff.weberCueId = "fluteI:194" \set Staff.weberCueLabel = "Fl." \cueDuringWithClef "fluteI" #UP "treble" { \voiceTwo \override MultiMeasureRest.staff-position = #-4  R1  \noBreak |  R1  | \revert MultiMeasureRest.staff-position } \oneVoice  | % PART I 194-195
