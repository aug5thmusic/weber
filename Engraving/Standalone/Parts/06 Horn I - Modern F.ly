...
\bookpart {
  ...
  \markup \column {
    ...
    \override #'(baseline-skip . 2.7) \abs-fontsize #11 \column {
      \override #'(line-width . 100) \wordwrap-string #"Modern alternative: horn in F, at the same sounding pitches as the original part."
      \vspace #0.8
...
\header { instrument = "Horn I — F" tagline = ##f }
\score {
\new Staff { \clef "treble" \transposition f \transpose c g, {
...
\barNumberCheck #120  \set Staff.weberCueId = "fluteI:120" \set Staff.weberCueLabel = "Fl. (8va)" \cueClef "treble" \transposedCueDuring "fluteI" #UP c' { \voiceTwo \override MultiMeasureRest.staff-position = #-10  R1  \noBreak |  R1  | \revert MultiMeasureRest.staff-position } \oneVoice \cueClefUnset  | % PART I 120-121
...
\barNumberCheck #205  \set Staff.weberCueId = "oboeOneI:205" \set Staff.weberCueLabel = "Ob. I" \cueDuringWithClef "oboeOneI" #UP "treble" { \voiceTwo \override MultiMeasureRest.staff-position = #-4  R1  \noBreak |  R1  | \revert MultiMeasureRest.staff-position } \oneVoice  | % PART I 205-206
...
\score {
\new Staff \with { \remove Page_turn_engraver } { \clef "treble" \transposition f \transpose c g, {
s1*0^\markup \bold "in F"
...
\score {
\new Staff \with { \remove Page_turn_engraver } { \clef "treble" \transposition f \time 3/4 \set Score.currentBarNumber = #17 \bar ".|:" \transpose c g, {
...
\barNumberCheck #29  \set Staff.weberCueId = "violinOneIII:29" \set Staff.weberCueLabel = "Vl. I" \cueDuringWithClef "violinOneIIItrio" #UP "treble" { \voiceTwo \override MultiMeasureRest.staff-position = #-8  R2.  \noBreak |  R2.  | \revert MultiMeasureRest.staff-position } \oneVoice  \noPageBreak | % PART III 29-30
...
\barNumberCheck #50 \mark \markup \override #'(box-padding . 0.4) \box \bold "C" \clef "bass" c'4\pp c'4 c'4->~  | % PART IV 50-50
...
\barNumberCheck #58  \clef "treble" g'2.~  | % PART IV 58-58
...
\barNumberCheck #80  \set Staff.weberCueId = "oboeOneIV:80" \set Staff.weberCueLabel = "Ob. I" \cueDuringWithClef "oboeOneIV" #UP "treble" { \voiceTwo \override MultiMeasureRest.staff-position = #-4  R2.  \noBreak |  R2.  | \revert MultiMeasureRest.staff-position } \oneVoice  | % PART IV 80-81
