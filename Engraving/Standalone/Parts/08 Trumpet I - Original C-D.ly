...
\bookpart {
  ...
  \markup \column {
    ...
    \vspace #0.8
    \fill-line { \abs-fontsize #13 "original C/D" }
    \vspace #3
    \fill-line { \abs-fontsize #12 "I. Allegro" \abs-fontsize #12 "2" }
    \vspace #0.65
    \fill-line { \abs-fontsize #12 "II. Adagio ma non troppo" \abs-fontsize #12 "4" }
    \vspace #0.65
    \fill-line { \abs-fontsize #12 "III. Menuetto — Allegro" \abs-fontsize #12 "4" }
    \vspace #0.65
    \fill-line { \abs-fontsize #12 "IV. Finale — Scherzo, presto" \abs-fontsize #12 "5" }
    \vspace #0.65
    \vspace #1.8
    \override #'(baseline-skip . 2.7) \abs-fontsize #11 \column {
      \override #'(line-width . 100) \wordwrap-string #"Movements I, III and IV: in C. Movement II: trumpet in D."
      \vspace #0.8
      ...
      \vspace #0.8
      \override #'(line-width . 100) \wordwrap-string #"The B-flat-trumpet alternative is supplied as a separate standalone part."
      \vspace #0.8
    }
    \vspace #2.0
...
\header { instrument = "Trumpet I — original C/D" tagline = ##f }
\score {
...
\barNumberCheck #50  d''4-. d''4-. r2\fermata  | % PART I 50-50
...
\barNumberCheck #174  \set Staff.weberCueId = "fluteI:174" \set Staff.weberCueLabel = "Fl." \cueDuringWithClef "fluteI" #UP "treble" { \voiceTwo \override MultiMeasureRest.staff-position = #-4  R1  \noBreak |  R1  | \revert MultiMeasureRest.staff-position } \oneVoice  | % PART I 174-175
...
\barNumberCheck #214  g'1~  | % PART I 214-214
...
\score {
\new Staff { \clef "treble" \transposition d' \transpose c c {
s1*0^\markup \bold "in D"
...
\barNumberCheck #29  \set Staff.weberCueId = "oboeOneII:29" \set Staff.weberCueLabel = "Ob. I" \cueDuringWithClef "oboeOneII" #UP "treble" { \voiceTwo \override MultiMeasureRest.staff-position = #-10  R1  \noBreak |  R1  | \revert MultiMeasureRest.staff-position } \oneVoice  | % PART II 29-30
...
\barNumberCheck #45  \set Staff.weberCueId = "oboeOneII:45" \set Staff.weberCueLabel = "Ob. I" \cueDuringWithClef "oboeOneII" #UP "treble" { \voiceTwo \override MultiMeasureRest.staff-position = #-10  R1  \noBreak |  R1  | \revert MultiMeasureRest.staff-position } \oneVoice  | % PART II 45-46
...
\barNumberCheck #180  \set Staff.weberCueId = "fluteIV:180" \set Staff.weberCueLabel = "Fl." \cueDuringWithClef "fluteIV" #UP "treble" { \voiceTwo \override MultiMeasureRest.staff-position = #-4  R2.  \noBreak |  R2.  | \revert MultiMeasureRest.staff-position } \oneVoice  | % PART IV 180-181
