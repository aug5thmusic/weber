...
\paper { page-count = #8 system-system-spacing.padding = #2.5 }
...
\addQuote "oboeOneIII" { \transposition c' \oboeOneIII }
\addQuote "oboeOneIIItrio" { \transposition c' \key c \major g'4(-\tweak stencil #weber-p-dolce -\tweak self-alignment-X #weber-p-dolce-alignment \p^\markup \italic "Solo" e''4 b'4 | c''2.) | f''4( cis''4 d''4 | ais'4-> b'4 g'4)~ | g'4 c''4-. e''4-. | g''2.->~ | g''4( fis''4 f''4 | d''4)-. e''4(-> c''4) | R2. | R2. | R2. | R2. | R2. | R2. | g'4(\mf^\markup \italic "Solo" c''4 e''4) | g''2.~ | g''4( fis''4 f''4 | d''4-.) e''4->( c''4) | R2. | R2. | }
...
\bookpart {
  ...
  \markup \column {
    ...
    \vspace #3.5
    \fill-line { \abs-fontsize #24 \bold "Bassoon I" }
    \vspace #0.8
...
\header { instrument = "Bassoon I" tagline = ##f }
\score {
\new Staff { \clef "bass" \transposition c' \transpose c c {
\barNumberCheck #1 \time 4/4 \tempo \markup { \bold \fontsize #1 "Allegro" } \key c \major c'4..\ff c'16 a4.. a16  | % PART I 1-1
\barNumberCheck #2  f4-. f4-. r2  | % PART I 2-2
\barNumberCheck #3  f'4\pp f'8. f'16 f'4 f'4  | % PART I 3-3
\barNumberCheck #4  f'2. r4  | % PART I 4-4
\barNumberCheck #5  d'4..\ff d'16 d'4.. d'16  | % PART I 5-5
\barNumberCheck #6  d'4-. d'4-. r2  | % PART I 6-6
\barNumberCheck #7  f'4\pp f'8. f'16 f'4 f'4  | % PART I 7-7
\barNumberCheck #8  e'4 r4 r2  | % PART I 8-8
\barNumberCheck #9  R1*3  | % PART I 9-11
\barNumberCheck #12  d'2^\markup \italic "Solo"~ d'8( e'16 d'16) cis'8-. d'8-.  | % PART I 12-12
\barNumberCheck #13  b8-. g,8-. f'4.-> e'8-. d'8-. c'8-.  | % PART I 13-13
\barNumberCheck #14  b8-. a8-. g8-. f8-. e8-. d8-. g8-. f8-.  | % PART I 14-14
\barNumberCheck #15  e4 c,2-> r4  | % PART I 15-15
\barNumberCheck #16 \mark \markup \override #'(box-padding . 0.4) \box \bold "A" R1*4  | % PART I 16-19
\barNumberCheck #20  r4 c'4(\p\< b4 bes4  | % PART I 20-20
\barNumberCheck #21  a4) aes4.\!\sf g8-.\p fis8-. f8-.  | % PART I 21-21
\barNumberCheck #22  e8 r8 f8 r8 g8 r8 g8 r8  | % PART I 22-22
\barNumberCheck #23  g2( c'8) r8 r4  | % PART I 23-23
\barNumberCheck #24  r4 c'4(\< b4 bes4  | % PART I 24-24
\barNumberCheck #25  a4) aes4.\!\sf g8-.\p fis8-. f8-.  | % PART I 25-25
\barNumberCheck #26  e8 r8 f8 r8 g8 r8 g,8 r8  | % PART I 26-26
\barNumberCheck #27 \mark \markup \override #'(box-padding . 0.4) \box \bold "B" c8\ff c'16 c'16 c'8 c'8 c'16(-> b16 a16 g16) g16(-> f16 e16 d16)  | % PART I 27-27
\barNumberCheck #28  c8 c'16 c'16 c'8 c'8 c'16(-> b16 a16 g16) g16(-> f16 e16 d16)  | % PART I 28-28
\barNumberCheck #29  c8 r8 c4_\markup \italic "cresc." d4 e4  | % PART I 29-29
\barNumberCheck #30  f4 fis4 g2  | % PART I 30-30
\barNumberCheck #31  g2:8 g2:8  | % PART I 31-31
\barNumberCheck #32  g8\< a8 b8 c'8 d'8 e'8 f'8 g'8  | % PART I 32-32
\barNumberCheck #33  g'4..\ff g'16 e'4.. e'16  | % PART I 33-33
\barNumberCheck #34  g4-. g4-. r2  | % PART I 34-34
\barNumberCheck #35  b4.. b16 b4.. b16  | % PART I 35-35
\barNumberCheck #36  b4-. b4-. r2  | % PART I 36-36
\barNumberCheck #37  a4.. a16 a4.. a16  | % PART I 37-37
\barNumberCheck #38  a4-. a4-. r2  | % PART I 38-38
\barNumberCheck #39  e4.. e16 e4.. e16  | % PART I 39-39
\barNumberCheck #40  e4-. e4-. r2  | % PART I 40-40
\barNumberCheck #41  c4 c8. c16 c4 c4  | % PART I 41-41
\barNumberCheck #42  b,1  | % PART I 42-42
\barNumberCheck #43  r8 d16( e16 fis16 g16 a16 b16 c'2)->~  | % PART I 43-43
\barNumberCheck #44  c'8 d16( e16 fis16 g16 a16 b16 c'2)->(  | % PART I 44-44
\barNumberCheck #45  b4) bes4(-> a4) cis'4(->  | % PART I 45-45
\barNumberCheck #46  d'4) bes4(-> a4) cis'4(->  | % PART I 46-46
\barNumberCheck #47  d'8) fis8\<( g8 gis8 a8\!-.) a8\<( bes8 b8  | % PART I 47-47
\barNumberCheck #48  c'8-.)\!_\markup \italic "cresc." fis8\<( g8 gis8 a8\!-.) a8\<( bes8 b8  | % PART I 48-48
\barNumberCheck #49  c'8-.)\ff r8 fis4 fis8 fis8 fis8 fis8  | % PART I 49-49
\barNumberCheck #50  fis4-. fis4-. r2\fermata  \pageBreak | % PART I 50-50
\barNumberCheck #51 \mark \markup \override #'(box-padding . 0.4) \box \bold "C" b1(\pp  | % PART I 51-51
\barNumberCheck #52  e'1)  | % PART I 52-52
\barNumberCheck #53  R1*5  | % PART I 53-57
\barNumberCheck #58  bes,1\f->  | % PART I 58-58
\barNumberCheck #59  a,1\pp  | % PART I 59-59
\barNumberCheck #60  g,2.( e,4)  | % PART I 60-60
\barNumberCheck #61  \clef "tenor" g'1(  | % PART I 61-61
\barNumberCheck #62  fis'8) d8(^\markup \italic "Solo" fis8 g8 a8 b8 c'8 cis'8)  | % PART I 62-62
\barNumberCheck #63  \grace { cis'16( d'16 e'16 } d'2)-> b4.. g'16  | % PART I 63-63
\barNumberCheck #64  g'2(-> e'4) r4  | % PART I 64-64
\barNumberCheck #65  e'8( d'8) d'8.-. d'16-. d'4 d'4  | % PART I 65-65
\barNumberCheck #66  e'4.( d'8 b4) r8. d'16  | % PART I 66-66
\barNumberCheck #67  d'2( b4) r8. ees'16  | % PART I 67-67
\barNumberCheck #68  ees'2( fis2)  | % PART I 68-68
\barNumberCheck #69 \mark \markup \override #'(box-padding . 0.4) \box \bold "D" ees'2\p~ ees'8 f'16( ees'16) d'8-. c'8-.  | % PART I 69-69
\barNumberCheck #70  f'2 \grace { f'8( } ees'8 d'8 ees'8 c'8)  | % PART I 70-70
\barNumberCheck #71  bes2 d'4(-> c'4)  | % PART I 71-71
\barNumberCheck #72  b2~ b8( c'8 d'8 ees'8)  | % PART I 72-72
\barNumberCheck #73  \after 8 \turnNatural f'4( f'8. g'16 aes'4) r4  | % PART I 73-73
\barNumberCheck #74  \clef "bass" R1*2  | % PART I 74-75
\barNumberCheck #76  d8 r8 r4 r2  | % PART I 76-76
\barNumberCheck #77  r8 b,8-. c8-. cis8-. d8-. cis8-. d8-. cis8-.  | % PART I 77-77
\barNumberCheck #78  d8 r8 e8\f r8 c8 r8 d8 r8  | % PART I 78-78
\barNumberCheck #79  R1*2  | % PART I 79-80
\barNumberCheck #81  r8 b,8-.\p c8-. cis8-. d8-. cis8-. d8-. cis8-.  | % PART I 81-81
\barNumberCheck #82  d8 r8 e8\f r8 c8 r8 d8 r8  | % PART I 82-82
\barNumberCheck #83 \mark \markup \override #'(box-padding . 0.4) \box \bold "E" g8\ff g16 g16 aes8-. g8-. a8-. g8-. bes8-. g8-.  | % PART I 83-83
\barNumberCheck #84  b8-. g8-. c'8-. g8-. cis'8-. g8-. d'8-. g8-.  | % PART I 84-84
\barNumberCheck #85  \clef "tenor" ees'4.. ees'16 ees'4.. ees'16  | % PART I 85-85
\barNumberCheck #86  ees'4 ees'2.->  | % PART I 86-86
\barNumberCheck #87  ees'4.. ees'16 ees'4.. ees'16  | % PART I 87-87
\barNumberCheck #88  ees'4 ees'2.->  | % PART I 88-88
\barNumberCheck #89  ees'4 ees'8. ees'16 ees'4 ees'4  | % PART I 89-89
\barNumberCheck #90  ees'2(-> d'4-.) r4  | % PART I 90-90
\barNumberCheck #91  \clef "bass" dis4 dis8. dis16 dis4 dis4  | % PART I 91-91
\barNumberCheck #92  dis2->~ dis8-. r8 dis'4  | % PART I 92-92
\barNumberCheck #93  e'8-. dis'8-. e'8-. d'8-. c'8-. d'8-. c'8-. b8-.  | % PART I 93-93
\barNumberCheck #94  c'4 c'4 b4 cis'4  | % PART I 94-94
\barNumberCheck #95  d'4 d4 d16 g,16 a,16 b,16 c16 d16 e16 fis16  | % PART I 95-95
\barNumberCheck #96  g16 d16 e16 fis16 g16 a16 b16 c'16 d'16 g16 a16 b16 c'16 d'16 e'16 fis'16  | % PART I 96-96
\barNumberCheck #97  g'16( fis'16 e'16 d'16 cis'16 d'16 e'16 fis'16 g'8) r8 b16( a16 b16 c'16)  | % PART I 97-97
\barNumberCheck #98  d'4 c4 d4 a4  | % PART I 98-98
\barNumberCheck #99  b1~  | % PART I 99-99
\barNumberCheck #100  b1  | % PART I 100-100
\barNumberCheck #101  b4.. b16 b4.. b16  | % PART I 101-101
\barNumberCheck #102  b4 b4 r2  \pageBreak | % PART I 102-102
...
\barNumberCheck #107  R1*6  | % PART I 107-112
\barNumberCheck #113  \omit Staff.CueEndClef \set Staff.weberCueId = "violinOneI:113" \set Staff.weberCueLabel = "Vl. I" \cueDuringWithClef "violinOneI" #UP "treble" { \voiceTwo \override MultiMeasureRest.staff-position = #-8  R1  \noBreak |  R1  | \revert MultiMeasureRest.staff-position } \oneVoice  | % PART I 113-114
\barNumberCheck #115  \clef "tenor" g'4-.(\pp\< g'4-. g'4-. g'4-.)  | % PART I 115-115
\barNumberCheck #116 \undo \omit Staff.CueEndClef  fis'2(\!\> g'4)\! r4  | % PART I 116-116
\barNumberCheck #117  R1*5  | % PART I 117-121
\barNumberCheck #122 \mark \markup \override #'(box-padding . 0.4) \box \bold "G" fis'1\ff~  | % PART I 122-122
\barNumberCheck #123  fis'8 fis'8( e'8 d'8 cis'8 b8 ais8 b8)  | % PART I 123-123
\barNumberCheck #124  fis'1~  | % PART I 124-124
\barNumberCheck #125  fis'8 e'8( d'8 cis'8 b8 ais8 gis8 ais8)  | % PART I 125-125
\barNumberCheck #126  fis'1~  | % PART I 126-126
\barNumberCheck #127  fis'8 fis'8( e'8 d'8 cis'8 b8 ais8 b8)  | % PART I 127-127
\barNumberCheck #128  ees'1~  | % PART I 128-128
\barNumberCheck #129  ees'8 fis'8( f'8 ees'8 d'8 c'8 b8 c'8)  | % PART I 129-129
\barNumberCheck #130  ees'1~  | % PART I 130-130
\barNumberCheck #131  ees'8 c'8( bes8 a8 g8 f8 e8 f8)  | % PART I 131-131
\barNumberCheck #132  des'1~  | % PART I 132-132
\barNumberCheck #133  des'8 f'8( ees'8 des'8 c'8 bes8 a8 bes8)  | % PART I 133-133
\barNumberCheck #134  \clef "bass" bes,4..\ff bes,16 d4.. f16  | % PART I 134-134
\barNumberCheck #135  bes8 f'8( ees'8 d'8 c'8 bes8 a8 bes8)  | % PART I 135-135
\barNumberCheck #136  bes,4.. bes,16 ees4.. g16  | % PART I 136-136
\barNumberCheck #137  bes8 g'8( f'8 ees'8 d'8 ees'8 f'8 ees'8)  | % PART I 137-137
\barNumberCheck #138  d'4.. b,16 d4.. g16  | % PART I 138-138
\barNumberCheck #139  b8 g'8( f'8 ees'8 d'8 c'8 b8 f'8)  | % PART I 139-139
\barNumberCheck #140  g,4.. g,16 c4.. ees16  | % PART I 140-140
\barNumberCheck #141  g8 g8( g'8 f'8 ees'8 d'8 ees'8 c'8)  | % PART I 141-141
\barNumberCheck #142  b8 g16( a16 b16 c'16 d'16 ees'16 f'2)->~  | % PART I 142-142
\barNumberCheck #143  f'8 g16( a16 b16 c'16 d'16 ees'16 f'2)->  | % PART I 143-143
\barNumberCheck #144 \mark \markup \override #'(box-padding . 0.4) \box \bold "H" \clef "tenor" f'4 ees'2-> ees'4  | % PART I 144-144
\barNumberCheck #145  ges'1->  | % PART I 145-145
\barNumberCheck #146  f'1~  | % PART I 146-146
\barNumberCheck #147  f'1  | % PART I 147-147
\barNumberCheck #148  R1*4  | % PART I 148-151
\barNumberCheck #152 \tempo "ritardando" f'4\pp f'8. f'16 f'4 f'4  | % PART I 152-152
\barNumberCheck #153  f'2~ f'8 r8 r4\fermata  | % PART I 153-153
\barNumberCheck #154 \tempo "Tempo I"  \mark \markup \override #'(box-padding . 0.4) \box \bold "J" \clef "bass" c'4..\ff c'16 a4.. a16  | % PART I 154-154
\barNumberCheck #155  f4-. f4-. r2  | % PART I 155-155
\barNumberCheck #156  f'4\pp f'8. f'16 f'4 f'4  | % PART I 156-156
\barNumberCheck #157  f'2. r4  | % PART I 157-157
\barNumberCheck #158  d'4..\ff d'16 d'4.. d'16  | % PART I 158-158
\barNumberCheck #159  d'4-. d'4-. r2  | % PART I 159-159
\barNumberCheck #160  f'4\pp f'8. f'16 f'4 f'4  | % PART I 160-160
\barNumberCheck #161  e'4 r4 r2  | % PART I 161-161
\barNumberCheck #162  R1*3  \pageBreak | % PART I 162-164
\barNumberCheck #165  d'2^\markup \italic "Solo"~ d'8( e'16 d'16) cis'8-. d'8-.  | % PART I 165-165
\barNumberCheck #166  b8-. g,8-. f'4.-> e'8-. d'8-. c'8-.  | % PART I 166-166
\barNumberCheck #167  b8-. a8-. g8-. f8-. e8( d8) g8.-. f16-.  | % PART I 167-167
\barNumberCheck #168  e4 c,2-> r4  | % PART I 168-168
\barNumberCheck #169  R1  | % PART I 169-169
\barNumberCheck #170  r4 aes4.\!\sf-> g8-.\p fis8-. f8-.  | % PART I 170-170
\barNumberCheck #171  e8 r8 r4 r2  | % PART I 171-171
\barNumberCheck #172  R1*2  | % PART I 172-173
\barNumberCheck #174  r4 aes4.\!\sf-> g8-.\p fis8-. f8-.  | % PART I 174-174
\barNumberCheck #175  e8 r8 r4 r2  | % PART I 175-175
\barNumberCheck #176  c8\ff c'16 c'16 c'8 c'8 c'16(-> b16 a16 g16) g16(-> f16 e16 d16)  | % PART I 176-176
\barNumberCheck #177  c8 c'16 c'16 c'8 c'8 c'16(-> b16 a16 g16) g16(-> f16 e16 d16)  | % PART I 177-177
\barNumberCheck #178  c8 r8 c4_\markup \italic "cresc." d4 e4  | % PART I 178-178
\barNumberCheck #179  f4 fis4 g2~  | % PART I 179-179
\barNumberCheck #180  g8 b8\<( c'8 cis'8\! ) d'8-. d'8\<( ees'8 e'8\!)  | % PART I 180-180
\barNumberCheck #181  f'8-. b8\<( c'8 cis'8\! ) d'8-. d'8\<( ees'8 e'8\!)  | % PART I 181-181
...
\barNumberCheck #191  ees1\f->(  | % PART I 191-191
\barNumberCheck #192  d2)\pp r2  | % PART I 192-192
\barNumberCheck #193  R1*2  | % PART I 193-194
\barNumberCheck #195  r8 g,8(^\markup \italic "Solo" b,8 c8 d8 e8 f8 fis8)  | % PART I 195-195
\barNumberCheck #196  g2( e4..) c'16  | % PART I 196-196
\barNumberCheck #197  \grace { b16( c'16 d'16 } c'2) a2  | % PART I 197-197
\barNumberCheck #198  a4(-> g8.) g16 g4 g4  | % PART I 198-198
\barNumberCheck #199  a4.(-> g8 e4) r8. g16  | % PART I 199-199
\barNumberCheck #200 \mark \markup \override #'(box-padding . 0.4) \box \bold "L" g2(-> e4..) aes16  | % PART I 200-200
\barNumberCheck #201  aes2(-> b,2)  | % PART I 201-201
\barNumberCheck #202  aes2~ aes8 bes16( aes16) g8-. f8-.  | % PART I 202-202
\barNumberCheck #203  bes2 \grace { bes8( } aes8) g8( aes8 f8)  | % PART I 203-203
\barNumberCheck #204  \after 4 \turn ees2( g4.-> f8)  | % PART I 204-204
\barNumberCheck #205  e2~ e8( f8 g8 aes8)  | % PART I 205-205
\barNumberCheck #206  bes4 \grace { c'16( bes16 a16 } bes8.) c'16 des'4 r4  | % PART I 206-206
\barNumberCheck #207  R1*3  | % PART I 207-209
\barNumberCheck #210  r8 e,8-.\p f,8-. fis,8-. g,8-. fis,8-. g,8-. fis,8-.  | % PART I 210-210
\barNumberCheck #211  g,4 a8\f r8 f8 r8 g8 r8  | % PART I 211-211
\barNumberCheck #212  R1*2  \pageBreak | % PART I 212-213
\barNumberCheck #214  r8 e,8-.\p f,8-. fis,8-. g,8-. fis,8-. g,8-. fis,8-.  | % PART I 214-214
\barNumberCheck #215  g,4 a8\f r8 f8 r8 g8 r8  | % PART I 215-215
...
\barNumberCheck #218  f4.. f16 f4.. f16  | % PART I 218-218
\barNumberCheck #219  b4 b2.->  | % PART I 219-219
\barNumberCheck #220  b4.. b16 b4.. b16  | % PART I 220-220
\barNumberCheck #221  b4 b2.->  | % PART I 221-221
\barNumberCheck #222  b4 b8. b16 b4 b4  | % PART I 222-222
\barNumberCheck #223  b2(-> c'8) r8 r4  | % PART I 223-223
\barNumberCheck #224  gis4\f gis8. gis16 gis4 gis4  | % PART I 224-224
\barNumberCheck #225  gis2->~ gis8 r8 gis4  | % PART I 225-225
\barNumberCheck #226  a8-. gis8-. a8-. g8-. f8-. g8-. f8-. e8-.  | % PART I 226-226
\barNumberCheck #227  f4 f4 e4 fis4  | % PART I 227-227
\barNumberCheck #228  g16 g,16 a,16 b,16 c16 d16 e16 f16 g16 c,16 d,16 e,16 f,16 g,16 a,16 b,16  | % PART I 228-228
\barNumberCheck #229  c16 g,16 a,16 b,16 c16 d16 e16 f16 g16 c16 d16 e16 f16 g16 a16 b16  | % PART I 229-229
\barNumberCheck #230  c'16 b16 a16 g16 fis16 g16 a16 b16 c'16 b16 c'16 d'16 e'16 d'16 e'16 f'16  | % PART I 230-230
\barNumberCheck #231  g'4 f4 g4 g4  | % PART I 231-231
\barNumberCheck #232 \mark \markup \override #'(box-padding . 0.4) \box \bold "N" c'4..\ff c'16 c'4.. c'16  | % PART I 232-232
\barNumberCheck #233  c'4 c'2 c'4  | % PART I 233-233
\barNumberCheck #234  c'4.. c'16 c'4.. c'16  | % PART I 234-234
\barNumberCheck #235  e'2 c'2  | % PART I 235-235
\barNumberCheck #236  g4 r4 g4 r4  | % PART I 236-236
...
\barNumberCheck #3  \clef "tenor" r2 e'2(\pp  | % PART II 3-3
\barNumberCheck #4  f'4 c'4 a4) r4  | % PART II 4-4
\barNumberCheck #5  e'2(-> f'4 a'4)  | % PART II 5-5
\barNumberCheck #6  c'8(\p e'16) r16 f'4( e'4) r4  | % PART II 6-6
\barNumberCheck #7  \clef "bass" f2(\< e2)  | % PART II 7-7
\barNumberCheck #8  gis2\f~ \tuplet 3/2 { gis8( f8 d8) } b,4->  | % PART II 8-8
\barNumberCheck #9  c2( e'2)  | % PART II 9-9
\barNumberCheck #10  e'2(-> f'4) r4  | % PART II 10-10
\barNumberCheck #11 \mark \markup \override #'(box-padding . 0.4) \box \bold "A" R1*8  | % PART II 11-18
...
\barNumberCheck #21  c,4->^\markup \italic "Solo" g'8.( a'32 g'32 f'8 e'8 d'8 c'8  | % PART II 21-21
\barNumberCheck #22  b8 a8) r4 r2  \pageBreak | % PART II 22-22
\barNumberCheck #23 \mark \markup \override #'(box-padding . 0.4) \box \bold "B" \clef "tenor" g8\f\< g8 b8 b8 c'8( d'8 e'8 f'8)  | % PART II 23-23
\barNumberCheck #24  f'2(\!-> e'4) r4  | % PART II 24-24
\barNumberCheck #25  R1  | % PART II 25-25
\barNumberCheck #26  f'2(\ff-> ees'8) r8 r4  | % PART II 26-26
\barNumberCheck #27  R1  | % PART II 27-27
\barNumberCheck #28  \clef "bass" r4 bes8(->\p a16)-. r16 r4 c'8(-> bes16)-. r16  | % PART II 28-28
\barNumberCheck #29  r4 a8(-> bes16)-. r16 r4 des'8(-> e16)-. r16  | % PART II 29-29
\barNumberCheck #30  e8(-> f16)-. r16 r4 r2  | % PART II 30-30
\barNumberCheck #31  R1\fermata  | % PART II 31-31
\barNumberCheck #32 \mark \markup \override #'(box-padding . 0.4) \box \bold "C" R1  | % PART II 32-32
\barNumberCheck #33  r2 r4  bes4(\<^\markup \italic "Solo"  | % PART II 33-33
\barNumberCheck #34  aes2) \clef tenor ges'2\ff->  | % PART II 34-34
\barNumberCheck #35 \mark \markup \override #'(box-padding . 0.4) \box \bold "D" \tuplet 3/2 4 { f'8[ f'8 f'8] f'8[ f'8 f'8] ges'8[ ges'8 ges'8] ges'8[ ges'8 ges'8] }  | % PART II 35-35
\barNumberCheck #36  \tuplet 6/4 { f'2.:8 } \tuplet 6/4 { f'2.:8 }  | % PART II 36-36
\barNumberCheck #37  \tuplet 6/4 { ges'2.:8 } \tuplet 6/4 { f'2.:8 }  | % PART II 37-37
\barNumberCheck #38  \tuplet 3/2 4 { ees'8 ees'8 ees'8 des'8 des'8 des'8 } c'4 r4  | % PART II 38-38
\barNumberCheck #39  \tuplet 6/4 { des'2.:8\f } \tuplet 6/4 { des'2.:8 }  | % PART II 39-39
\barNumberCheck #40  \tuplet 6/4 { c'2.:8 } \tuplet 6/4 { c'2.:8 }  | % PART II 40-40
\barNumberCheck #41  fis'4.\fp^\markup \italic "Solo" ees'8( d'8\< c'8 f'8 fis'8)  | % PART II 41-41
\barNumberCheck #42  g'4.(\ff ees'8) c'4 r4  | % PART II 42-42
\barNumberCheck #43  \clef "bass" fis2 \tuplet 6/4 { fis2.:8 }  | % PART II 43-43
\barNumberCheck #44 \mark \markup \override #'(box-padding . 0.4) \box \bold "E" \once \override TextScript.extra-offset = #'(-2 . 0) \override TupletNumber.extra-offset = #'(0 . 1.4) \tuplet 3/2 4 { g,8\p^\markup \italic "Soli" bes,8 ees8 g8 bes8 ees'8 } g'2-> \revert TupletNumber.extra-offset  | % PART II 44-44
\barNumberCheck #45  f'4\f f4~ \once \override TupletNumber.extra-offset = #'(0 . 2.2) \tuplet 3/2 { f8 f8( ees8 } \tuplet 3/2 { d8 c8 b,8) }  | % PART II 45-45
\barNumberCheck #46  bes,4\ff bes,,2 \tuplet 3/2 { f8( e8 d8) }  | % PART II 46-46
\barNumberCheck #47  fis'2(\p d'2)  | % PART II 47-47
\barNumberCheck #48  b2\ff \tuplet 6/4 { b2.:8 }  | % PART II 48-48
\barNumberCheck #49  a2(\pp f2)  | % PART II 49-49
\barNumberCheck #50  R1  | % PART II 50-50
\barNumberCheck #51  r2 c'4(\pp bes4)  | % PART II 51-51
\barNumberCheck #52 \mark \markup \override #'(box-padding . 0.4) \box \bold "F" a2( cis'2  | % PART II 52-52
\barNumberCheck #53  a1  | % PART II 53-53
\barNumberCheck #54  g2 bes2)  | % PART II 54-54
\barNumberCheck #55  a4 r4 r2  | % PART II 55-55
\barNumberCheck #56  ees'4(\p^\markup \italic "Solo" d'8. c'16) ges'4(-> f'8 ees'8)  | % PART II 56-56
\barNumberCheck #57  d'2 r2  | % PART II 57-57
\barNumberCheck #58 \tempo "ritardando" d'2(\pp\> c'4 b4  | % PART II 58-58
\barNumberCheck #59  c'1)\ppp\fermata \bar "|." | % PART II 59-59
\barNumberCheck #60
} }
...
\score {
\new Staff \with { \remove Page_turn_engraver } { \clef "bass" \transposition c' \transpose c c {
\barNumberCheck #1 \time 3/4 \tempo \markup { \bold \fontsize #1 "Allegro" } \bar ".|:" \key c \minor c'2.(\pp^\markup \italic "Soli"  \noPageBreak | % PART III 1-1
\barNumberCheck #2  f'2.\<  \noPageBreak | % PART III 2-2
\barNumberCheck #3  ees'4 d'4 c'4)  \noPageBreak | % PART III 3-3
\barNumberCheck #4  b4-.\! b4-. r4  \noPageBreak | % PART III 4-4
\barNumberCheck #5  r4 ees4-.\ff-> e4-.  \noPageBreak | % PART III 5-5
\barNumberCheck #6  r4 f4-.-> fis4-.  \noPageBreak | % PART III 6-6
\barNumberCheck #7  g4-. bes4-. d'4-.  \noPageBreak | % PART III 7-7
\barNumberCheck #8  g4-. g,4-. r4 \bar ":|.|:" \noPageBreak | % PART III 8-8
\barNumberCheck #9 \mark \markup \override #'(box-padding . 0.4) \box \bold "A" bes,4-.\ff c4-. d4-.  \noPageBreak | % PART III 9-9
\barNumberCheck #10  ees4-. f4-. g4-.  \noPageBreak | % PART III 10-10
\barNumberCheck #11  aes4-. bes4-. c'4-.  \noPageBreak | % PART III 11-11
\barNumberCheck #12  d'4-. ees'4-. f'4-.  \noPageBreak | % PART III 12-12
\barNumberCheck #13  ees'4-. ees4-.-> e4-.  \noPageBreak | % PART III 13-13
\barNumberCheck #14  r4 f4-.-> fis4-.  \noPageBreak | % PART III 14-14
\barNumberCheck #15  g4(-> aes4) g4-.  \noPageBreak | % PART III 15-15
\barNumberCheck #16  ees4-. c4-. r4 \bar ":|." \once \override Score.TextMark.direction = #DOWN \textEndMark \markup \italic "Fine" \noPageBreak | % PART III 16-16
\barNumberCheck #17
} }
...
\score {
\new Staff \with { \remove Page_turn_engraver } { \clef "bass" \transposition c' \time 3/4 \set Score.currentBarNumber = #17 \bar ".|:" \key c \major \transpose c c {
\barNumberCheck #17 \key c \major    \mark \markup \line { \override #'(box-padding . 0.4) \box \bold "B" \hspace #0.6 \fontsize #-1.5 \bold "Trio" } \key c \major R2.*8  \noPageBreak | % PART III 17-24
...
\barNumberCheck #31  \set Staff.weberCueId = "oboeOneIII:31" \set Staff.weberCueLabel = "Ob. I" \cueDuringWithClef "oboeOneIIItrio" #UP "treble" { \voiceTwo \override MultiMeasureRest.staff-position = #-6  R2.  \noBreak |  R2.  | \revert MultiMeasureRest.staff-position } \oneVoice  \noPageBreak | % PART III 31-32
\barNumberCheck #33  f'2.\p->  \noPageBreak | % PART III 33-33
\barNumberCheck #34  f'4-. e'4->( g'4)  \noPageBreak | % PART III 34-34
...
\barNumberCheck #8  c'2-> b4  | % PART IV 8-8
\barNumberCheck #9  c'2-> b4  | % PART IV 9-9
\barNumberCheck #10  a8( b8 c'8 d'8 e'4-.)  | % PART IV 10-10
\barNumberCheck #11  fis'4-. d'4-. g'4-.  | % PART IV 11-11
\barNumberCheck #12  R2.*6  | % PART IV 12-17
\barNumberCheck #18  a8(\p b8 c'8 d'8  e'4-.)  | % PART IV 18-18
\barNumberCheck #19  fis'4-. d'4-. g'4-.  | % PART IV 19-19
\barNumberCheck #20 \mark \markup \override #'(box-padding . 0.4) \box \bold "A" g8(\ff a8 bes8 c'8  d'4-.)  | % PART IV 20-20
\barNumberCheck #21  a8( b8 c'8 d'8  e'4-.)  | % PART IV 21-21
\barNumberCheck #22  f8( g8 a8 b8  c'4-.)  | % PART IV 22-22
\barNumberCheck #23  b4-. e4-. r4\fermata  | % PART IV 23-23
\barNumberCheck #24  c8(\pp d8 e8 f8 g4->~)  | % PART IV 24-24
\barNumberCheck #25  g8( a8 bes8 b8 c'4-.)  | % PART IV 25-25
\barNumberCheck #26  f8( g8 a8 b8  c'4-.)  | % PART IV 26-26
\barNumberCheck #27  d'4-. g4-. c'4-.  | % PART IV 27-27
...
\barNumberCheck #34 \mark \markup \override #'(box-padding . 0.4) \box \bold "B" g8(\ff a8 bes8 c'8  d'4-.)  | % PART IV 34-34
\barNumberCheck #35  a8( b8 c'8 d'8  e'4-.)  | % PART IV 35-35
\barNumberCheck #36  f8( g8 a8 b8  c'4-.)  | % PART IV 36-36
\barNumberCheck #37  b4-. e4-. r4\fermata  | % PART IV 37-37
\barNumberCheck #38  c8(\p d8 e8 f8 g4->~)  | % PART IV 38-38
\barNumberCheck #39  g8( a8 bes8 b8 c'4-.)  | % PART IV 39-39
\barNumberCheck #40  f8( g8 a8 b8  c'4-.)  | % PART IV 40-40
\barNumberCheck #41  d'4-. g4-. c'4-.  | % PART IV 41-41
...
\barNumberCheck #46  fis8( g8 a8 b8  c'4-.)  | % PART IV 46-46
\barNumberCheck #47  f'2-> e'4  | % PART IV 47-47
\barNumberCheck #48  f'2.\sf  | % PART IV 48-48
\barNumberCheck #49  e'4 r4 r4  | % PART IV 49-49
\barNumberCheck #50 \mark \markup \override #'(box-padding . 0.4) \box \bold "C" R2.*6  | % PART IV 50-55
\barNumberCheck #56  \omit Staff.CueEndClef \set Staff.weberCueId = "oboeOneIV:56" \set Staff.weberCueLabel = "Ob. I" \cueDuringWithClef "oboeOneIV" #UP "treble" { \voiceTwo \override MultiMeasureRest.staff-position = #-4  R2.  \noBreak |  R2.  | \revert MultiMeasureRest.staff-position } \oneVoice  | % PART IV 56-57
\barNumberCheck #58  \clef "tenor" g4(\p^\markup \italic "Solo" b4 d'4)  | % PART IV 58-58
\barNumberCheck #59 \undo \omit Staff.CueEndClef  f'2.->  | % PART IV 59-59
\barNumberCheck #60  e'2 c'4  | % PART IV 60-60
\barNumberCheck #61  dis'8( e'8 f'8 e'8 c'4)  | % PART IV 61-61
\barNumberCheck #62  g4 b4 d'4  | % PART IV 62-62
\barNumberCheck #63  f'2.->  | % PART IV 63-63
\barNumberCheck #64  e'2 c'4  | % PART IV 64-64
\barNumberCheck #65  dis'8( e'8 f'8 e'8 c'4)  | % PART IV 65-65
\barNumberCheck #66 \mark \markup \override #'(box-padding . 0.4) \box \bold "D" \clef "bass" R2.*4  | % PART IV 66-69
\barNumberCheck #70  d,8(^\markup \italic "Solo" e,8 fis,8 g,8 a,8 b,8  | % PART IV 70-70
\barNumberCheck #71  c8 d8 e8 fis8 g8 a8  | % PART IV 71-71
\barNumberCheck #72  b2) r4  | % PART IV 72-72
\barNumberCheck #73  R2.  | % PART IV 73-73
\barNumberCheck #74  dis'2.\pp~  | % PART IV 74-74
\barNumberCheck #75  dis'2.  | % PART IV 75-75
\barNumberCheck #76  e'2.  | % PART IV 76-76
\barNumberCheck #77  g4( a4 b4  | % PART IV 77-77
\barNumberCheck #78  c'2) r4  | % PART IV 78-78
\barNumberCheck #79  R2.*3  | % PART IV 79-81
\barNumberCheck #82  f2.\ff->~  | % PART IV 82-82
\barNumberCheck #83  f2.  | % PART IV 83-83
\barNumberCheck #84 \mark \markup \override #'(box-padding . 0.4) \box \bold "E" e4-.\ff e4-. fis4-.  | % PART IV 84-84
\barNumberCheck #85  gis4-. a4-. b4-.  | % PART IV 85-85
\barNumberCheck #86  c'4-. b4-. a4->~  | % PART IV 86-86
\barNumberCheck #87  a4 b4-. c'4-.  | % PART IV 87-87
\barNumberCheck #88  b4-. e4-. e'4-.  | % PART IV 88-88
\barNumberCheck #89  d'4-. c'4-. b4-.  | % PART IV 89-89
\barNumberCheck #90  a4-. b4-. c'4->~  | % PART IV 90-90
\barNumberCheck #91  c'4 a4-. dis4-.  | % PART IV 91-91
\barNumberCheck #92  e4-. e4-. gis4-.  | % PART IV 92-92
\barNumberCheck #93  a4-. b4-. c'8-. d'8-.  | % PART IV 93-93
\barNumberCheck #94  e'4-. e4-. gis4-.  | % PART IV 94-94
\barNumberCheck #95  a4-. b4-. c'8-. d'8-.  | % PART IV 95-95
\barNumberCheck #96  e'4-. gis4-. gis4-.  | % PART IV 96-96
\barNumberCheck #97  gis4-. gis4-. gis4-.  | % PART IV 97-97
\barNumberCheck #98  gis4 r4 r4  | % PART IV 98-98
\barNumberCheck #99  R2.  | % PART IV 99-99
\barNumberCheck #100 \mark \markup \override #'(box-padding . 0.4) \box \bold "F" R2.*16  \pageBreak | % PART IV 100-115
\barNumberCheck #116  R2.*6  | % PART IV 116-121
\barNumberCheck #122  \set Staff.weberCueId = "violinTwoIV:122" \set Staff.weberCueLabel = "Vl. II" \cueDuringWithClef "violinTwoIV" #UP "treble" { \voiceTwo \override MultiMeasureRest.staff-position = #2  R2.  \noBreak |  R2.  | \revert MultiMeasureRest.staff-position } \oneVoice  | % PART IV 122-123
\barNumberCheck #124  b8(\pp^\markup \italic "Solo" c'8 d'8 e'8 f'4)  | % PART IV 124-124
\barNumberCheck #125  R2.*4  | % PART IV 125-128
...
\barNumberCheck #138  \set Staff.weberCueId = "hornOneIV:138" \set Staff.weberCueLabel = "Cor. I" \cueDuringWithClef "hornOneIV" #UP "bass" { \voiceTwo \override MultiMeasureRest.staff-position = #-4  R2.  \noBreak |  R2.  | \revert MultiMeasureRest.staff-position } \oneVoice  | % PART IV 138-139
\barNumberCheck #140  g,8(\p\< a,8 b,8 c8 d8 e8)  | % PART IV 140-140
\barNumberCheck #141  f8( g8 a8 b8 c'8 d'8)  | % PART IV 141-141
\barNumberCheck #142 \mark \markup \override #'(box-padding . 0.4) \box \bold "H" e'4\ff e8( f8 g4->)~  | % PART IV 142-142
...
\barNumberCheck #146  c'2-> b4  | % PART IV 146-146
\barNumberCheck #147  c'2-> b4  | % PART IV 147-147
...
\barNumberCheck #158  g8(\ff a8 bes8 c'8  d'4-.)  | % PART IV 158-158
\barNumberCheck #159  a8( b8 c'8 d'8  e'4-.)  | % PART IV 159-159
\barNumberCheck #160  f8( g8 a8 b8  c'4-.)  | % PART IV 160-160
\barNumberCheck #161  b4-. e4-. r4\fermata  | % PART IV 161-161
\barNumberCheck #162 \mark \markup \override #'(box-padding . 0.4) \box \bold "J" c8(\pp^\markup \italic "Solo" d8 e8 f8 g4->~)  | % PART IV 162-162
\barNumberCheck #163  g8( a8 bes8 b8 c'4-.)  | % PART IV 163-163
\barNumberCheck #164  f8( g8 a8 b8  c'4-.)  | % PART IV 164-164
\barNumberCheck #165  d'4-. g4-. c'4-.  | % PART IV 165-165
\barNumberCheck #166  f2\f-> e4  | % PART IV 166-166
\barNumberCheck #167  d2-> cis4  | % PART IV 167-167
\barNumberCheck #168  d8(-> e8 f8 g8  a4-.)  | % PART IV 168-168
\barNumberCheck #169  b4-.-> g4-. c'4-.  | % PART IV 169-169
\barNumberCheck #170  g,8(\ff a,8 b,8 c8  d4-.)  | % PART IV 170-170
...
\barNumberCheck #174  f'4-. f4-.-> g4-.  | % PART IV 174-174
\barNumberCheck #175  a4 r4 r4  | % PART IV 175-175
\barNumberCheck #176  r4 f4-.-> g4-.  | % PART IV 176-176
\barNumberCheck #177  a4-. g4-. a4-.  | % PART IV 177-177
\barNumberCheck #178  a8( bes8 c'8 d'8  ees'4-.)  | % PART IV 178-178
\barNumberCheck #179  fis8( g8 a8 bes8  c'4-.)  | % PART IV 179-179
\barNumberCheck #180  a2.~  | % PART IV 180-180
\barNumberCheck #181  a2.  | % PART IV 181-181
...
\barNumberCheck #184  aes2.~  | % PART IV 184-184
\barNumberCheck #185  aes2.~  | % PART IV 185-185
\barNumberCheck #186  aes2.~  | % PART IV 186-186
\barNumberCheck #187  aes2.~  | % PART IV 187-187
\barNumberCheck #188  aes4 c'4( d'4  | % PART IV 188-188
\barNumberCheck #189  ees'4\< f'4 fis'4)  | % PART IV 189-189
\barNumberCheck #190 \mark \markup \override #'(box-padding . 0.4) \box \bold "L" g'8(\ff g8 a8 b8  c'4-.)  | % PART IV 190-190
\barNumberCheck #191  dis'8( e'8 f'8 fis'8  g'4-.)  | % PART IV 191-191
\barNumberCheck #192  b8( c'8 d'8 dis'8  e'4-.)  | % PART IV 192-192
\barNumberCheck #193  fis8( g8 a8 b8  c'4-.)  | % PART IV 193-193
\barNumberCheck #194  f'2.~  | % PART IV 194-194
\barNumberCheck #195  f'2.  | % PART IV 195-195
\barNumberCheck #196  fis8(-> g8 a8 b8  c'4-.)  | % PART IV 196-196
\barNumberCheck #197  b2 c'4  | % PART IV 197-197
\barNumberCheck #198  f'2.\sf(  | % PART IV 198-198
...
\barNumberCheck #202  fis,8(\pp g,8 a,8 b,8 c4-.)  | % PART IV 202-202
